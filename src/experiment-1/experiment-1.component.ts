import html from './experiment-1.component.html?inline';
import css from './experiment-1.component.css?inline';


const template = document.createElement('template');
template.innerHTML = `<style>${css}</style>${html}`;

export const TAG_NAME = 'exexperiment-1';

export class Experiment1Component extends HTMLElement {
    constructor() {
        super();
